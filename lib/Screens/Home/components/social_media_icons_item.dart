...
import 'package:nowproject/Screens/Home/components/social_media_icons.dart';
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SocialMediaIcons(
            icon: Image.asset('assets/images/xApp.png'),
          ),
          SizedBox(
            width: 10.w,
          ),
          ...
          SocialMediaIcons(
            icon: Image.asset('assets/images/instaIcon.png'),
          ),
          SizedBox(
            width: 10.w,
          ),
