...
import 'package:nowproject/Screens/Chossing%20Maid/components/custom_skills_search.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      CustomSkillsInSearch(
                        skillsText: 'الطبخ',
                        width: 72,
                      ),
                      CustomSkillsInSearch(
                        skillsText: 'رعاية كبار السن',
                        width: 120,
                      ),
                      CustomSkillsInSearch(
                        skillsText: 'رعاية الأطفال',
                        width: 90,
                      ),
                    ],
                  ),
        ...
        Positioned(top: 108.h, child: const CustomCircleAvatar()),
      ],
    );
  }
}
